...
/** Category of additions for `<HMDatabase>` class.
...
@interface HMDatabase (HMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `HMResultSet` of schema; `nil` on error.
...
- (HMResultSet*)getTableSchema:(NSString*)tableName;

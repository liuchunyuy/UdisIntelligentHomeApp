...
extern NSString *const HMAsyncUdpSocketException;
extern NSString *const HMAsyncUdpSocketErrorDomain;

extern NSString *const HMAsyncUdpSocketQueueName;
extern NSString *const HMAsyncUdpSocketThreadName;

enum HMAsyncUdpSocketError
{
	HMAsyncUdpSocketNoError = 0,          // Never used
	HMAsyncUdpSocketBadConfigError,       // Invalid configuration
	HMAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	HMAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	HMAsyncUdpSocketClosedError,          // The socket was closed
	HMAsyncUdpSocketOtherError,           // Description provided in userInfo
};
typedef enum HMAsyncUdpSocketError HMAsyncUdpSocketError;
 ...
 * Example:
 * 
 * HMAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^HMAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id *context);
 ...
 *
**/
typedef BOOL (^HMAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface HMAsyncUdpSocket : NSObject

/**
 * HMAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, HMAsyncSocket will automatically create its own socket queue.
 ...
 * 
 * This means HMAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, HMAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, HMAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, HMAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that HMAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about HMAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(HMAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(HMAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * HMAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, HMAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about HMAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(HMAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(HMAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The HMAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally HMAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
...
@protocol HMAsyncUdpSocketDelegate
@optional
...
**/
- (void)udpSocket:(HMAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(HMAsyncUdpSocket *)sock didNotConnect:(NSError *)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(HMAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(HMAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(HMAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(HMAsyncUdpSocket *)sock withError:(NSError *)error;
